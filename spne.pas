...
type 
  ...
  DetectorClass=Class
    ...
    function GetOmega(x:Vec3):real;virtual;abstract;
  end;
  SphereClass=class(DetectorClass)
    ...
    function GetOmega(x:Vec3):real;override;
  end;
  CamRecord=record
    o,d:Vec3;
    PlaneDist:real;
...
function SphereClass.GetOmega(x:Vec3):real;
begin
...
begin
  ...
  sph.add(SphereClass.Create( 10000, 
                              Cen+p.new(0,0,-200),     
                              e.new(0.00063842, 0.02001478, 0.28923243)*6e-2*8, 
                              c.new(0.7,0.7,1)*0.25,  
                              DIFF)); // sky
